    ...
    <motion.div 
      ...
      <div className="w-1/2 p-10 bg-gradient-to-br from-yellow-200 to-gray-100">
        ...
        <motion.form initial={{ scale: 0.9 }} animate={{ scale: 1 }} transition={{ duration: 0.3 }}>
          ...
          <input type="email" placeholder="Email" className="w-full p-3 mb-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400" />
          <motion.button 
                      whileHover={{ scale: 1.05 }} className="w-full bg-yellow-500 text-white py-3 rounded-md hover:bg-yellow-600 transition">Send Reset Link</motion.button>
        </motion.form>
      </div>
       <motion.div 
