...
function ProfileDropdown() {
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-full bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50 items-center">
                    <div className="flex gap-2">
                        ...
                        />
                        <div className="text-sm flex flex-col justify-center w-full items-start">
                    ...
                    <FaAngleDown className="mr-2 size-5 text-gray-400" />
                </MenuButton>
            </div>
            ...
            >
                <div className="py-1">
                    <MenuItem>
                        ...
                        <button className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3  text-sm text-gray-700 font-semibold data-[focus]:bg-white/10">
